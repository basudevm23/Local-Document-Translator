...
3. Once you are in the virtual environment: pip install -r reqfile.txt

4. Type the following command, it will redirect you to the interface: uvicorn app.main:app --reload --port 8000
